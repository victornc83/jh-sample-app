...
public class EmpleadoResourceIntTest {
    ...
    private static final Long DEFAULT_COMISION_PCT = 1L;
    private static final Long UPDATED_COMISION_PCT = 2L;
    ...
    public static Empleado createEntity(EntityManager em) {
        Empleado empleado = new Empleado()
            ...
            .comisionPct(DEFAULT_COMISION_PCT);
        return empleado;
    }
    ...
    public void createEmpleado() throws Exception {
        ...
        assertThat(testEmpleado.getApellido1()).isEqualTo(DEFAULT_APELLIDO_1);
        assertThat(testEmpleado.getApellido2()).isEqualTo(DEFAULT_APELLIDO_2);
        ...
        assertThat(testEmpleado.getComisionPct()).isEqualTo(DEFAULT_COMISION_PCT);
    }
    ...
    public void getAllEmpleados() throws Exception {
        ...
        restEmpleadoMockMvc.perform(get("/api/empleados?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].comisionPct").value(hasItem(DEFAULT_COMISION_PCT.intValue())));
    }
    ...
    public void getEmpleado() throws Exception {
        ...
        restEmpleadoMockMvc.perform(get("/api/empleados/{id}", empleado.getId()))
            ...
            .andExpect(jsonPath("$.comisionPct").value(DEFAULT_COMISION_PCT.intValue()));
    }
    ...
    public void updateEmpleado() throws Exception {
        ...
        updatedEmpleado
            ...
            .comisionPct(UPDATED_COMISION_PCT);
        ...
        assertThat(testEmpleado.getApellido1()).isEqualTo(UPDATED_APELLIDO_1);
        assertThat(testEmpleado.getApellido2()).isEqualTo(UPDATED_APELLIDO_2);
        ...
        assertThat(testEmpleado.getComisionPct()).isEqualTo(UPDATED_COMISION_PCT);
    }
